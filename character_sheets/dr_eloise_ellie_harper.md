...
Small, dependable, reasonably powerful, and widely available, the 10mm pistol has been a staple of wasteland combat since the bombs first fell. Its versatility and potential for customization mean that a well-looked-after 10mm pistol will keep its owner safe for a long time.
...
Grip: Comfort Grip, Sharpshooter&rsquo;s Grip
...
### Polierte Pfanne "Sophie"

- **Damage**: 4 ()
- **Range**: close

Eine Pfanne, die Ellie in einer Notsituation das Leben rettete und von Marcel auf Hochglanz poliert wurde.
...
The switchblade is a commonly found melee weapon. Its small size means that it is easily smuggled into restricted areas and is easy to handle. It doesn&rsquo;t do as damage as larger knives or blades, however.
Switchblades can accept the following mod which is installed with the Repair skill:
...
A simple, lightweight hat, normally with a peak or brim to keep the sunlight out of the wearer&rsquo;s eyes.
Special: A character wearing a casual hat ignores any difficulty increases caused by extremely bright light.
Brauner Cowboy Hut aus Oasis Springs.

### Formal Clothing

**Covers**: ARML, ARMR, LEGL, LEGR, TORSO

A nice suit, a pretty dress, or some other kind of fancy, tailored clothing. Designed to be more flattering than functional, formal clothing is helpful when you need to impress someone, and is often prized as a sign of status, presenting the appearance of someone who doesn&rsquo;t need to worry about their own safety.
...
Formal clothing can be reinforced with Ballistic Weave (see sidebar, p. 126).

### Formal Hat

**Covers**: HEAD

A smart-looking hat, that&rsquo;ll look the part adorning your head during a business engagement or formal event. Or just because you like how it looks and it keeps the sun off your face. Many examples are somewhat battered and worn from neglect and ill-use, but they&rsquo;re still functional.
...
Formal hats can be reinforced with Ballistic Weave (see sidebar).

### Lab Coat

**Covers**: ARML, ARMR, LEGL, LEGR, TORSO

A white coat&mdash;though likely stained or dirty&mdash; intended for use in a laboratory environment. Normally contains a useful number of pockets, and clock or sensor just below the left lapel, where it can be easily checked without having to reach for it&mdash;ideal during delicate scientific work.
Special: Between the utility of the design, and simply feeling smarter while wearing one, a lab coat allows you to re-roll a single d20 on one INT based skill test you make each scene.
A lab coat can be reinforced with Ballistic Weave (see sidebar, p. 126).
...
**Resistances**: Energy +1, Radiation +2

The standard garment for all vault inhabitants, provided by Vault-Tec. A close-fitting blue jumpsuit with a golden-yellow strip running around the neck, down the torso, and along the sleeves. This strip is a metallic foil which aids in heat dissipation and works with the suit&rsquo;s integrated biometric scanners. Each Vault Jumpsuit has a number on the back, signifying which vault it originated from.
A Vault Jumpsuit can be modified with an additional protective lining, taking one of the mods below. All Vault Jumpsuit mods are installed with the Repair skill.
Vault Jumpsuit: Insulated Lining, Treated Lining, Resistant Lining, Protective Lining, Shielded Lining
...
A pack full of bandages, antiseptic spray, and other tools useful in helping clean and bind injuries in the field. First aid kits also often come with Stimpaks and RadAway, but these are used and tracked separately

### Glowing Goo (x3)

### Multi-Tool

A handy little device, containing a set of pliers, some wire cutters, a variety of small wrenches and screw drivers, and other small tools, all built into a single tool. Different parts fold out of the handles as needed. Ideal for someone who needs basic tools but is still travelling light.

### Pip-Boy

A Personal Information Processor manufactured by RobCo Industries. Under partnership with Vault-Tec, they were issued to many vault residents, though due to production constraints and ongoing development, different vaults received shipments of different versions of the Pip-Boy. The versions most encountered are variants of the Pip-Boy 2000 and Pip-Boy 3000, which are designed to be secured upon the wearer&rsquo;s wrist. Many models were designed with biometric locks, preventing them from being removed while the wearer still lives.
...
The device maintains an ongoing log of the wearer&rsquo;s activities, journey, and condition, and place for personal recordings to be made in either text or audio forms.
...
Geburtsort: Vault 77, irgendwo in Nevada
Gr&ouml;&szlig;e: 1,56m
Beruf: &Auml;rztin und Biochemikerin, Vertiefung Allgemeinmedizin und Genetik
Regelwerk
Laborkittel
Spezial: Abgesehen davon, dass er praktisch gestaltet ist und du dich einfach schlauer f&uuml;hlst, wenn du ihn tr&auml;gst, darfst du mit einem Laborkittel bei einer INT-basierten Fertigkeitsprobe pro Szene einen einzelnen W20 neu w&uuml;rfeln. Ein Laborkittel kann mit ballistischem Gewebe verst&auml;rkt werden (siehe Kasten S. 126).
Dein ges&uuml;nderer Start ins Leben in den H&auml;nden ausgebildeter &Auml;rzte und fortschrittlicher Auto-Docs reduziert die Schwierigkeit aller AUS-Proben, um den Auswirkungen von Krankheiten zu widerstehen, um &ndash;1. Dar&uuml;ber hinaus bedeutet deine sorgf&auml;ltig geplante Erziehung, dass du eine zus&auml;tzliche Spezialfertigkeit deiner Wahl erh&auml;ltst.
temp: Gl&uuml;ck -2 am 09.04.25

---

*Character sheet generated on 2025-11-23 16:18*
